...
@property (nonatomic, strong) APRAdsConfiguration * _Nonnull configuration;
...
SWIFT_CLASS("_TtC9AppierAds19APRAdsConfiguration")
@interface APRAdsConfiguration : NSObject
...
typedef SWIFT_ENUM(NSInteger, APRErrorType, open) {
  ...
  APRErrorTypeDataConvertError = 12,
  APRErrorTypeRequestNotExist = 13,
};

@protocol APRInterstitialAdDelegate;

SWIFT_CLASS("_TtC9AppierAds17APRInterstitialAd")
@interface APRInterstitialAd : AppierBaseAd
@property (nonatomic, weak) id <APRInterstitialAdDelegate> _Nullable delegate;
- (nonnull instancetype)initWithAdUnitId:(id <APRAdUnitIdentifier> _Nonnull)adUnitId OBJC_DESIGNATED_INITIALIZER;
- (void)load;
- (void)show;
@end
...
SWIFT_PROTOCOL("_TtP9AppierAds25APRInterstitialAdDelegate_")
@protocol APRInterstitialAdDelegate
- (void)onAdNoBid:(APRInterstitialAd * _Nonnull)interstitialAd;
- (void)onAdLoaded:(APRInterstitialAd * _Nonnull)interstitialAd;
- (void)onAdLoadedFailed:(APRInterstitialAd * _Nonnull)interstitialAd error:(APRError * _Nonnull)error;
- (void)onAdShown:(APRInterstitialAd * _Nonnull)interstitialAd;
- (void)onAdShownFailed:(APRInterstitialAd * _Nonnull)interstitialAd;
- (void)onAdDismiss:(APRInterstitialAd * _Nonnull)interstitialAd;
- (void)onAdClickedRecorded:(APRInterstitialAd * _Nonnull)interstitialAd;
@end
